...
class Dog extends Pet {
  ...
  getDetails(): void {
    console.log(
      `Name: ${this.name}, Age: ${this.age}, Type: Dog, Breed: ${
        this.breed
...
class Cat extends Pet {
  ...
  getDetails(): void {
    console.log(
      `Name: ${this.name}, Age: ${this.age}, Type: Cat, Color: ${
        this.color
      }, Available: ${this.available ? "Yes" : "No"}`
    );
  }
...
class AdoptionCenter {
  ...
  findAdopter(id: number): Adopter | undefined {
